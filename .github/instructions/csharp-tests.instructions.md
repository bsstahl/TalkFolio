...
* Fields at class top, alphabetically by name
* Service under test named `target`
...
public class EndpointDataProcessorTests
{
    ...
    private readonly EndpointDataProcessor<FakeSource, FakeSink> _target;

    public EndpointDataProcessor_ProcessDataAsync_Should()
    {
        ...
        _target = new EndpointDataProcessor<FakeSource, FakeSink>(_options, _httpClient);
    }

    [Fact]
    public async Task ReturnParsedResponse_WhenValidRequest()
    {
        // Arrange
        ...
        // Act
        var actual = await _target.ProcessDataAsync(new FakeSource { Id = 1 }, CancellationToken.None);
    ...
    [Fact]
    public async Task ThrowHttpRequestException_WhenServerError()
    {
        // Arrange
        ...
        await Assert.ThrowsAsync<HttpRequestException>(
            () => _target.ProcessDataAsync(new FakeSource { Id = 1 }, CancellationToken.None));
    }
